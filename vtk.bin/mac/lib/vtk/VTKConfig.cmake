...
SET(VTK_INCLUDE_DIRS "/opt/rappture-runtime/VTK4.4/build/include/vtk;/usr/X11R6/include;/opt/rappture/include;/opt/rappture/include")

# The VTK library directories.
SET(VTK_LIBRARY_DIRS "/opt/rappture-runtime/VTK4.4/build/lib/vtk")

# The C and C++ flags added by VTK to the cmake-configured flags.
SET(VTK_REQUIRED_C_FLAGS " -no-cpp-precomp -I/usr/X11R6/include")
SET(VTK_REQUIRED_CXX_FLAGS " -Wno-deprecated -no-cpp-precomp -I/usr/X11R6/include")
...
SET(VTK_USE_FILE "/opt/rappture-runtime/VTK4.4/build/lib/vtk/UseVTK.cmake")

# The build settings file.
SET(VTK_BUILD_SETTINGS_FILE "/opt/rappture-runtime/VTK4.4/build/lib/vtk/VTKBuildSettings.cmake")

# The directory containing class list files for each kit.
SET(VTK_KITS_DIR "/opt/rappture-runtime/VTK4.4/build/lib/vtk")

# The wrapping hints file.
SET(VTK_WRAP_HINTS "/opt/rappture-runtime/VTK4.4/build/lib/vtk/hints")

# CMake extension module directory and macro file.
SET(VTK_LOAD_CMAKE_EXTENSIONS_MACRO "/opt/rappture-runtime/VTK4.4/build/lib/vtk/CMake/vtkLoadCMakeExtensions.cmake")
SET(VTK_CMAKE_EXTENSIONS_DIR "/opt/rappture-runtime/VTK4.4/build/lib/vtk/CMake")
...
SET(VTK_TCL_HOME "/opt/rappture-runtime/VTK4.4/build/lib/vtk/tcl")
SET(VTK_JAVA_JAR "")
SET(VTK_PARSE_JAVA_EXE "")
SET(VTK_WRAP_JAVA_EXE "")
SET(VTK_WRAP_PYTHON_EXE "")
SET(VTK_WRAP_TCL_EXE "/opt/rappture-runtime/VTK4.4/build/bin/vtkWrapTcl")
SET(VTK_DOXYGEN_HOME "/opt/rappture-runtime/VTK4.4/build/lib/vtk/doxygen")
SET(VTK_TK_INTERNAL_DIR "/opt/rappture-runtime/VTK4.4/build/include/vtk/tkInternals/tk84OSX")

# The VTK test script locations.
SET(VTK_HEADER_TESTING_PY "/opt/rappture-runtime/VTK4.4/build/lib/vtk/testing/HeaderTesting.py")
SET(VTK_FIND_STRING_TCL "/opt/rappture-runtime/VTK4.4/build/lib/vtk/testing/FindString.tcl")
SET(VTK_PRINT_SELF_CHECK_TCL "/opt/rappture-runtime/VTK4.4/build/lib/vtk/testing/PrintSelfCheck.tcl")
SET(VTK_RT_IMAGE_TEST_TCL "/opt/rappture-runtime/VTK4.4/build/lib/vtk/testing/rtImageTest.tcl")
SET(VTK_PRT_IMAGE_TEST_TCL "/opt/rappture-runtime/VTK4.4/build/lib/vtk/testing/prtImageTest.tcl")
...
IF(NOT VTK_NO_LIBRARY_DEPENDS)
  INCLUDE("/opt/rappture-runtime/VTK4.4/build/lib/vtk/VTKLibraryDepends.cmake")
